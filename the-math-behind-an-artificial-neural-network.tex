...
\begin{titlepage}
    ...
    \begin{neuralnetwork}[height=10, nodespacing=25mm, layerspacing=35mm, nodesize=30pt]
    	\newcommand{\inputtext}[2]{$a^{(l-3)}_#2$}
    	\newcommand{\hiddentext}[2]{$a^{(l-2)}_#2$}
    	\newcommand{\hiddentwotext}[2]{$a^{(l-1)}_#2$}
        \newcommand{\outputtext}[2]{$a^{(l)}_#2$}
        \inputlayer[count=5, bias=false, text=\inputtext]
        \hiddenlayer[count=6, bias=false, text=\hiddentext]
        \linklayers
        \hiddenlayer[count=6, bias=false, text=\hiddentwotext]
        \linklayers
        \outputlayer[count=3, text=\outputtext]
        \linklayers
    \end{neuralnetwork}
    \vfill
    \includegraphics[width=4cm]{img/olivia-with-text}\\
    \href{https://olivia-ai.org}{\underline{https://olivia-ai.org}}
\end{titlepage}
